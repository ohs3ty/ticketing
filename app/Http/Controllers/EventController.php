...
class EventController extends Controller
{
    ...
    public function index() {
        ...
        $ticket_counts = Event::select('events.id', 'event_name', 'ticket_types.ticket_name', 'ticket_types.ticket_cost', 'ticket_types.ticket_limit', DB::raw('(ticket_limit - ticket_count) as ticket_left'))
                            ->leftJoin('ticket_types', 'ticket_types.event_id', 'events.id')
