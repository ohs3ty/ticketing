      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {{ Form::text('cashnet_code', $organization->cashnet_code, ['class' => 'form-control'])}}
            </div>

            <div class="form-group">
                {{ Form::label('organization_website', 'Organization Website')}}<br>
                {{ Form::text('organization_website', $organization->organization_website, ['class' => 'form-control'])}}
            </div>
        </div>
