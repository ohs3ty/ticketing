...
<div id="card1" class="card" style="border-color: grey;">
    <div class="card-body">
        <h5 class="card-title">Ticket Group:</h5>
        <div class="container">
            ...
            <div class="row no-gutters">
                <div class="card-text col-sm-6">
                    ...
                    @enderror
                    {{ Form::label('ticket_name', 'Ticket Name') }}<br>
                ...
                <div class="card-text col-sm-3">
                    {{ Form::label('ticket_type', 'Ticket Type')}}<br>
                    {{ Form::select('ticket_type', array(1 => "General", 2 => "Student", 3 => "BYU Employee"), null, array('class' => 'custom-select-sm w-75')) }}
                </div>
            </div>
            <br>
            <div class="row no-gutters">
